...
return [
    ...
    'expires' => [
        ...
        'application/x-shockwave-flash' => '+1 month',
        'font/eot' => '+1 month',
    ...
    /**
     * Valid types are "*", "cache", "cookies", "storage",
     * "executionContexts", "prefetchCache", "prerenderCache",
     * and some browsers support "clientHints".
     */
    'types' => ['*']
];
